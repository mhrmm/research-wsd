...
from reed_wsd.mnist.examples import build_interface_a_net, run_interface_a_input
from reed_wsd.mnist.examples import build_interface_b_net, run_interface_b_input
